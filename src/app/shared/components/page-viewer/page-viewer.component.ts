...
export class PageViewerComponent implements OnChanges, OnInit {
  ...
  initPageInfo() {
    ...
    this.pageViewerOptions.firstPageText = this.i18nService.transform('PAGE_FIRST');
    this.pageViewerOptions.previousPageText = this.i18nService.transform('PAGE_PREVIOUS');
    this.pageViewerOptions.nextPageText = this.i18nService.transform('PAGE_NEXT');
    this.pageViewerOptions.lastPageText = this.i18nService.transform('PAGE_LAST');
  ...
  updatePageInfo(options?: IPageViewerOptions) {
    if (options) {
